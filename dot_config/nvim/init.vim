...
"  }}}
"  Look {{{
  call dein#add('vim-airline/vim-airline')               " a bar.
...
"  What is that? {{{
  ...
  call dein#add('/home/romain/git/pytodoist.nvim')
...
autocmd Filetype todoist nnoremap tt :call AssignLabel('today')<CR>
autocmd Filetype todoist nnoremap tw :call AssignLabel('thisweek')<CR>
